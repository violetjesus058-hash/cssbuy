...
const IMAGE_META = {
  ...
  'sneakers-unboxing-premium-uk-02.webp': {
    ...
    scene: 'Hands unboxing Jordan 4 Fire Red from shoebox, CSSBuy printout, QC Passed 96% card, UK Express/EU Standard shipping labels, Adidas Samba box visible'
  },
  'clothing-streetwear-outfit-us-03.webp': {
    ...
    scene: 'Three friends on LA Melrose Ave sidewalk: man in Essentials hoodie + cargo pants, woman in Stussy tee + jeans, man in Gallery Dept splatter jacket + white pants, Nike shopping bag, cssbuy Express cyclist'
  },
  'clothing-wardrobe-organized-au-04.webp': {
    ...
    scene: 'Woman in bedroom holding grey hoodie, comparing with CSSBuy printout, organized wardrobe with Stussy/Nike items, laptop showing product grid, shipping labels: Australia Express 5-8 Days, US Standard 10-15 Days, UK Economy 12-18 Days'
  },
  'accessories-daily-carry-us-05.webp': {
    ...
    scene: 'Flat lay: Cartier Tank watch being held, Chrome Hearts ring, Ray-Ban sunglasses, Saint Laurent wallet, AirPods, CSSBuy product finds CSSBuy on phone showing prices, USPS Priority mail, International Tracking box'
  },
