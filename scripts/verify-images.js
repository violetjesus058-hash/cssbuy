...
const IMAGE_META = {
  ...
  'sneakers-unboxing-premium-uk-02.webp': {
    ...
    scene: 'Hands unboxing Jordan 4 Fire Red from shoebox, CSSBuy printout, QC Passed 96% card, UK/EU shipping labels, Adidas Samba box'
  },
  'clothing-streetwear-outfit-us-03.webp': {
    ...
    scene: 'Three friends walking on LA street (Melrose Ave), wearing Essentials hoodie, Stussy tee, Gallery Dept jacket, Nike shopping bag, cssbuy Express cyclist in background'
  },
  'clothing-wardrobe-organized-au-04.webp': {
    ...
    scene: 'Woman in bedroom comparing hoodie with CSSBuy printout, organized wardrobe with Stussy/Nike items, laptop showing product grid, shipping labels (Australia Express 5-8 Days, US Standard 10-15 Days, UK Economy 12-18 Days)'
  },
  'accessories-daily-carry-us-05.webp': {
    ...
    scene: 'Flat lay of accessories: Cartier Tank watch, Chrome Hearts ring, Ray-Ban sunglasses, Saint Laurent wallet, AirPods, CSSBuy product finds CSSBuy on phone, USPS Priority mail, International Tracking box'
  },
